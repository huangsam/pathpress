...
### Added
- Prioritized toddler POIs over formal museums and castles for young family trips.
...
### Fixed
- Fixed Ollama output failure with MLX models by removing unneeded format constraint.
