...
| [**Spatial Data & Routing Engine**](spatial-routing.md) | OpenStreetMap PBF hierarchy (State, Regional, Nationwide), GraphHopper caching (`.graphhopper/<slug>`), memory scaling, and spatial indexing. |
